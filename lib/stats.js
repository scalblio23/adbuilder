...
function listBookings() {
  ...
  return Promise.all([docs.list('bookings'), accounts.list(), listTracked()]).then(function (r) {
    var rows = {}; r[0].forEach(function (b) { rows[b.id] = b; });
    var acctClient = {}; r[2].forEach(function (t) { if (t.adAccountId && !acctClient[t.adAccountId]) acctClient[t.adAccountId] = clientSlug(t.adAccountName || t.adAccountId); });
    var out = [], used = {};

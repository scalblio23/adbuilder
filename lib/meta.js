...
module.exports = { config: config, notConfigured: notConfigured, whoAmI: whoAmI, adAccounts: adAccounts, campaigns: campaigns, campaignStats: campaignStats, videoSource: videoSource, pause: pause, LABELS: LABELS, labelFor: labelFor };

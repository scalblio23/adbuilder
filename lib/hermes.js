...
module.exports = { config: config, test: test, launch: launch, send: send, explain: explain, pullAccounts: pullAccounts, pullMeta: pullMeta, payload: payload, buildPrompt: buildPrompt, DEFAULTS: DEFAULTS };

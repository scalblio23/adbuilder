...
module.exports = { config: config, test: test, launch: launch, pullAccounts: pullAccounts, pullMeta: pullMeta, payload: payload, buildPrompt: buildPrompt, DEFAULTS: DEFAULTS };
